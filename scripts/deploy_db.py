...
DB_URL = os.getenv(
    "DATABASE_URL",
    "postgresql://postgres.cgqukhmqnndwdbmkmjrn:@dnjsdl2572@aws-0-ap-northeast-2.pooler.supabase.com:6543/postgres"
)
...
def main():
    ...
    log("="*60)
    log(f"Target: {DB_URL.split('@')[1].split(':')[0]}...")  # Hide password
